package com.topopixel.library.langchain.java.llms.openai.sdk;
...
import com.theokanning.openai.finetune.*;
...
public class OpenAiService {
    ...
    private static String base = "https://api.openai.com/";
    ...
    public OpenAiService(final String token) {
        this(token, DEFAULT_TIMEOUT, base);
    }

    public OpenAiService(final String token, final String base) {
        this(token, DEFAULT_TIMEOUT, base);
    }
     ...
     */
    public OpenAiService(final String token, final Duration timeout, final String base) {
        if (base.endsWith("/")) {
            OpenAiService.base = base;
        } else {
            OpenAiService.base = base + "/";
        }
